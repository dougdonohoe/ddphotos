...
**Deploy in seconds with [Surge↗](https://surge.sh)** (free, fast, simple):
...
There are many ways to deploy a static site like this. The quickest is
[Surge↗](https://surge.sh) — one command and your site is live at a public URL, free.
